    ...
    <div key={prospect.id} className="relative bg-white dark:bg-super-dark-secondary rounded-lg shadow-md border border-slate-200 dark:border-super-dark-border overflow-hidden group">
      ...
      <div className="p-3 text-center"> {/* Added text-center for alignment */}
        ...
        <div className="mt-2 flex justify-center items-center gap-2">
          <span className="text-xs bg-gray-100 text-gray-700 dark:bg-super-dark-border dark:text-super-dark-text-primary px-2 py-1 rounded-full font-semibold">#{prospect.ranking || 'N/A'}</span>
          <span className="text-xs bg-purple-100 text-purple-700 dark:bg-purple-900/50 dark:text-purple-300 px-2 py-1 rounded-full font-semibold">Tier {prospect.tier}</span>
        </div>
