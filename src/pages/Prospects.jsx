      ...
      <div className="max-w-7xl mx-auto px-6 py-6">
        ...
        {viewMode === 'grid' ? (
          ...
          <div className="bg-white rounded-xl shadow-sm border overflow-hidden">
            {/* Cabeçalho da Lista - Visível apenas em telas maiores */}
            ...
            <div className="divide-y divide-gray-100">
              {filteredProspects.map((prospect, index) => {
                ...
                return (
                  <Link to={`/prospects/${prospect.id}`} key={prospect.id || prospect.name} className="block px-4 md:px-6 py-4 hover:bg-gray-50 transition-colors">
                    <div className="grid grid-cols-4 md:grid-cols-12 gap-4 items-center">
                      {/* Coluna Principal: Rank, Nome e Time (Mobile e Desktop) */}
                      <div className="col-span-3 md:col-span-5 flex items-center space-x-4">
                        <span className={`hidden md:inline-flex items-center justify-center w-8 h-8 rounded-full text-xs font-bold ${
                        ...
                        <div>
                          ...
                          <div className="text-sm text-gray-500 md:hidden">{prospect.position} • {prospect.high_school_team || 'N/A'}</div>
                        </div>
                      </div>
                      
                      {/* Colunas de Stats (Desktop) */}
                      ...
                      <div className="hidden md:col-span-1 md:text-center text-gray-800 font-medium">
                      ...
                      <div className="hidden md:col-span-3 text-gray-600">
                      ...
                      <div className="col-span-1 md:col-span-1 flex justify-end">
                        <div className="flex items-center gap-2">
                          <button
                            onClick={(e) => { e.preventDefault(); toggleWatchlist(prospect.id); }}
